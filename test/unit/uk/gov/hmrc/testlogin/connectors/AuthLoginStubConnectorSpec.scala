  ...
  "createSession" should {
    "return a logged in session for an individual" in new Setup {
      ...
      stubFor(post(urlEqualTo("/auth-login-stub/gg-sign-in"))
        ...
        .withRequestBody(containing("enrolment[0].name=IR-SA"))
        .withRequestBody(containing("enrolment[0].taxIdentifier[0].name=UTR"))
        .withRequestBody(containing("enrolment[0].taxIdentifier[0].value=1097172564"))
    ...
    "return a logged in session for an organisation" in new Setup {
      ...
      stubFor(post(urlEqualTo("/auth-login-stub/gg-sign-in"))
        ...
        .withRequestBody(containing("enrolment[0].name=IR-SA"))
        .withRequestBody(containing("enrolment[0].taxIdentifier[0].name=UTR"))
        .withRequestBody(containing("enrolment[0].taxIdentifier[0].value=1097172565"))
        .withRequestBody(containing("enrolment[0].state=Activated"))
        .withRequestBody(containing("enrolment[1].name=IR-CT"))
        .withRequestBody(containing("enrolment[1].taxIdentifier[0].name=UTR"))
        .withRequestBody(containing("enrolment[1].taxIdentifier[0].value=543212311774"))
        .withRequestBody(containing("enrolment[1].state=Activated"))
        .withRequestBody(containing("enrolment[2].name=HMCE-VATDEC-ORG"))
        .withRequestBody(containing("enrolment[2].taxIdentifier[0].name=VATRegNo"))
        .withRequestBody(containing("enrolment[2].taxIdentifier[0].value=999981316"))
        .withRequestBody(containing("enrolment[2].state=Activated"))
        .withRequestBody(containing("enrolment[3].name=IR-PAYE"))
        .withRequestBody(containing("enrolment[3].taxIdentifier[0].name=TaxOfficeNumber"))
        .withRequestBody(containing("enrolment[3].taxIdentifier[0].value=904"))
        .withRequestBody(containing("enrolment[3].taxIdentifier[1].name=TaxOfficeReference"))
        .withRequestBody(containing("enrolment[3].taxIdentifier[1].value=HZ00067"))
